				...
				<section id="header">
					...
					<!-- Nav -->
						...
						<section id="intro">
								<div class="container">
									<section>
										<div align="center">Liverpool 이용약관</div>
											<div>
...
제 5 장  손해배상
 ...
 요금 등 서비스 이용으로 발생한 분쟁에 대해 소송이 제기될 경우 회사의 본사 소재지 법원을 관할법원으로 합니다.
								...
								<div align="center">
									<button type="button" class="button alt" onclick="document.location='Register.jsp'">동의합니다.</button>
									<button type="button" class="button alt" onclick="history.back()">동의하지 않습니다.</button>
								</div>
